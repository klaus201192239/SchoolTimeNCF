...
@interface UserInformationViewController : UIViewController<UITextFieldDelegate,UITableViewDataSource,UITableViewDelegate,UIAlertViewDelegate>


@property(atomic,retain) IBOutlet UITextField * PhoneEdit;
