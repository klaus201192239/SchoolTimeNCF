//
//  OutActivityCommentViewController.h
//  SchoolTimeNCF
//
...
@interface OutActivityCommentViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
